      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <form onSubmit={handleEmail} className="space-y-2.5">
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-sm font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
